defmodule Aoe.Y20.Day19Test do
  use ExUnit.Case, async: true

  alias Aoe.Y20.Day19, as: Solution, warn: false
  ...
  test "verify 2020/19 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2020, 19, :part_one)
  end
  ...
  test "verify 2020/19 part two" do
    assert {:ok, @part_two_solution} == Aoe.run(2020, 19, :part_two)
  end
end
