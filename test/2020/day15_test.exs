defmodule Aoe.Y20.Day15Test do
  use ExUnit.Case, async: true

  alias Aoe.Y20.Day15, as: Solution, warn: false
  ...
  test "verify 2020/15 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2020, 15, :part_one)
  end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2020, 15, :part_two)
  # end
end
