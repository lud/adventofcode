defmodule Aoe.Y20.Day9Test do
  use ExUnit.Case, async: true

  alias Aoe.Y20.Day9, as: Solution, warn: false
  ...
  test "verify 2020/9 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2020, 9, :part_one)
  end
  ...
  test "verify 2020/9 part two" do
    assert {:ok, @part_two_solution} == Aoe.run(2020, 9, :part_two)
  end
end
