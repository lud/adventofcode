defmodule AdventOfCode.Solutions.Y20.Day10Test do
  use ExUnit.Case, async: true

  alias AdventOfCode.Solutions.Y20.Day10, as: Solution, warn: false
  ...
  test "verify 2020/10 part one" do
    assert {:ok, @part_one_solution} == AoC.run(2020, 10, :part_one)
  end
  ...
  test "verify 2020/10 part two" do
    assert {:ok, @part_two_solution} == AoC.run(2020, 10, :part_two)
  end
end
