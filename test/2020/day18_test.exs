defmodule Aoe.Y20.Day18Test do
  use ExUnit.Case, async: true

  alias Aoe.Y20.Day18, as: Solution, warn: false
  ...
  test "verify 2020/18 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2020, 18, :part_one)
  end
  ...
  test "verify 2020/18 part two" do
    assert {:ok, @part_two_solution} == Aoe.run(2020, 18, :part_two)
  end
end
