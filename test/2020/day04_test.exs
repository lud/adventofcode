defmodule AdventOfCode.Solutions.Y20.Day04Test do
  use ExUnit.Case, async: true

  alias AdventOfCode.Solutions.Y20.Day04, as: Solution, warn: false
  ...
  test "verify 2020/4 part one" do
    assert {:ok, @part_one_solution} == AoC.run(2020, 4, :part_one)
  end
  ...
  test "verify 2020/4 part two" do
    assert {:ok, @part_two_solution} == AoC.run(2020, 4, :part_two)
  end
end
