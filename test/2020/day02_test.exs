defmodule AdventOfCode.Solutions.Y20.Day02Test do
  use ExUnit.Case, async: true

  alias AdventOfCode.Solutions.Y20.Day02, as: Solution, warn: false
  ...
  test "verify 2020/2 part one" do
    assert {:ok, @part_one_solution} == AoC.run(2020, 2, :part_one)
  end
  ...
  test "verify 2020/2 part two" do
    assert {:ok, @part_two_solution} == AoC.run(2020, 2, :part_two)
  end
end
