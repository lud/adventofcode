defmodule Aoe.Y20.Day7Test do
  use ExUnit.Case, async: true

  alias Aoe.Y20.Day7, as: Solution, warn: false
  ...
  test "verify 2020/7 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2020, 7, :part_one)
  end
  ...
  test "verify 2020/7 part two" do
    assert {:ok, @part_two_solution} == Aoe.run(2020, 7, :part_two)
  end
end
