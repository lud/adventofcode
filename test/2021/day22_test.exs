defmodule Aoe.Y21.Day22Test do
  use ExUnit.Case, async: true

  alias Aoe.Y21.Day22, as: Solution, warn: false
  ...
  test "verify 2021/22 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2021, 22, :part_one)
  end
  ...
  test "verify 2021/22 part two" do
    assert {:ok, @part_two_solution} == Aoe.run(2021, 22, :part_two)
  end
end
