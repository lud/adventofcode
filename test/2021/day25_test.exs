defmodule Aoe.Y21.Day25Test do
  use ExUnit.Case, async: true

  alias Aoe.Y21.Day25, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == Aoe.run(2021, 25, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2021, 25, :part_two)
  # end
end
