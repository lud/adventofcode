defmodule Aoe.Y21.Day23Test do
  use ExUnit.Case, async: true

  alias Aoe.Y21.Day23, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == Aoe.run(2021, 23, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2021, 23, :part_two)
  # end
end
