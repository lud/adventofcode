defmodule Aoe.Y22.Day25Test do
  use ExUnit.Case, async: true

  alias Aoe.Y22.Day25, as: Solution, warn: false
  ...
  test "verify 2022/25 part one" do
    assert {:ok, @part_one_solution} == Aoe.run(2022, 25, :part_one)
  end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2022, 25, :part_two)
  # end
end
