defmodule AdventOfCode.Solutions.Y22.Day15Test do
  use ExUnit.Case, async: true

  alias AdventOfCode.Solutions.Y22.Day15, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == AoC.run(2022, 15, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == AoC.run(2022, 15, :part_two)
  # end
end
