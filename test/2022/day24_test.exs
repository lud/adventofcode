defmodule AdventOfCode.Solutions.Y22.Day24Test do
  use ExUnit.Case, async: true

  alias AdventOfCode.Solutions.Y22.Day24, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == AoC.run(2022, 24, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == AoC.run(2022, 24, :part_two)
  # end
end
