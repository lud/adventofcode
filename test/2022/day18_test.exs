defmodule Aoe.Y22.Day18Test do
  use ExUnit.Case, async: true

  alias Aoe.Y22.Day18, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == Aoe.run(2022, 18, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2022, 18, :part_two)
  # end
end
