defmodule AdventOfCode.Solutions.Y22.Day16Test do
  use ExUnit.Case, async: true

  alias AdventOfCode.Solutions.Y22.Day16, as: Solution, warn: false
  ...
  test "verify 2022/16 part one" do
    assert {:ok, @part_one_solution} == AoC.run(2022, 16, :part_one)
  end
  ...
  #   assert {:ok, @part_two_solution} == AoC.run(2022, 16, :part_two)
  # end
end
