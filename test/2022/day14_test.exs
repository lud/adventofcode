defmodule Aoe.Y22.Day14Test do
  use ExUnit.Case, async: true

  alias Aoe.Y22.Day14, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == Aoe.run(2022, 14, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2022, 14, :part_two)
  # end
end
