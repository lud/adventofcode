defmodule Aoe.Y19.Day22Test do
  use ExUnit.Case, async: true

  alias Aoe.Y19.Day22, as: Solution, warn: false
  ...
  #   assert {:ok, @part_one_solution} == Aoe.run(2019, 22, :part_one)
  # end
  ...
  #   assert {:ok, @part_two_solution} == Aoe.run(2019, 22, :part_two)
  # end
end
